...
public class SelectedHospitalActivity extends AppCompatActivity {
    TextView tvSelectedHospitalLocation, tvSelectedHospitalAddress, tvSelectedHospitalState, BacktoHome;
    Button purchase;
    Toolbar toolbar;
    ImageView tvSelectedHospitalName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null){
            ...
            tvSelectedHospitalName.setImageResource(hospitalsModel.getHname());
...
//        BacktoHomeImg = findViewById(R.id.sushrutaHomeImgg);
        ...
        BacktoHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SelectedHospitalActivity.this, HomeActivity.class));
            }
        });
...
//        });
        ...
        purchase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SelectedHospitalActivity.this, PurchaseActivity.class).putExtra("data", hospitalsModel));
            }
        });
